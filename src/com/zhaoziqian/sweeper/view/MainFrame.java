...
public class MainFrame extends JFrame {
	...
	private void initFrame(){
		...
		int frameWidth = 
				10 + 10 + 
				(GamePanel.ITEM_RADUS + GamePanel.ITEM_BORDER) * rootMap[0].length 
				+ GamePanel.ITEM_BORDER;
		
		int frameHeight = 
				50 + 30 + 30 + 
				(GamePanel.ITEM_RADUS + GamePanel.ITEM_BORDER) * rootMap.length 
				+ GamePanel.ITEM_BORDER;
		...
		Panel gameMap = new GamePanel(rootMap);
